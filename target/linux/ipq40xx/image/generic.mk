...
define Device/Common/FitzImage
...
define Device/Common/DniImage
	$(call Device/Common/FitzImage)
	NETGEAR_BOARD_ID :=
	NETGEAR_HW_ID :=
	IMAGES += factory.img
...
define Device/8dev_habanero-dvk
	$(call Device/Common/FitImageLzma)
...
define Device/Common/8dev_jalapeno
...
define Device/8dev_jalapeno
	$(call Device/Common/8dev_jalapeno)
	DEVICE_VENDOR := 8devices
...
define Device/Common/aruba_glenmorangie
	$(call Device/Common/FitImageLzma)
	DEVICE_VENDOR := Aruba
	SOC := qcom-ipq4029
endef
...
define Device/aruba_ap-303
	$(call Device/Common/aruba_glenmorangie)
	DEVICE_MODEL := AP-303
endef
...
# - change call Device/Common/FitImageLzma to Device/Common/FitImage
...
define Device/Common/kernel-size-6350-8300
	DEVICE_COMPAT_VERSION := 2.0
...
define Device/linksys_ea6350v3
	...
	$(call Device/Common/FitzImage)
	$(call Device/Common/kernel-size-6350-8300)
...
define Device/Common/netgear_ex61x0v2
	$(call Device/Common/DniImage)
...
define Device/netgear_ex6100v2
	$(call Device/Common/netgear_ex61x0v2)
	DEVICE_MODEL := EX6100
	DEVICE_VARIANT := v2
endef
# Missing DSA Setup
...
define Device/Common/netgear_orbi
	$(call Device/Common/DniImage)
	SOC := qcom-ipq4019
	DEVICE_VENDOR := NETGEAR
...
define Device/Common/netgear_rbx50
	$(call Device/Common/netgear_orbi)
...
define Device/netgear_rbr50
	$(call Device/Common/netgear_rbx50)
	DEVICE_MODEL := RBR50
	DEVICE_VARIANT := v1
...
define Device/Common/netgear_srx60
	$(call Device/Common/netgear_orbi)
...
define Device/netgear_srr60
	$(call Device/Common/netgear_srx60)
	DEVICE_MODEL := SRR60
...
define Device/Common/p2w_r619ac
	$(call Device/Common/FitzImage)
	$(call Device/Common/UbiFit)
	DEVICE_VENDOR := P&W
	DEVICE_MODEL := R619AC
