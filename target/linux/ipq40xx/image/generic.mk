...
define DeviceCommon/FitImage
	KERNEL_SUFFIX := -uImage.itb
	KERNEL = kernel-bin | gzip | fit gzip $$(KDIR)/image-$$(DEVICE_DTS).dtb
	KERNEL_NAME := Image
endef

define DeviceCommon/FitImageLzma
	KERNEL_SUFFIX := -uImage.itb
	KERNEL = kernel-bin | lzma | fit lzma $$(KDIR)/image-$$(DEVICE_DTS).dtb
	KERNEL_NAME := Image
endef

define DeviceCommon/FitzImage
	KERNEL_SUFFIX := -zImage.itb
	KERNEL = kernel-bin | fit none $$(KDIR)/image-$$(DEVICE_DTS).dtb
	KERNEL_NAME := zImage
endef

define DeviceCommon/UbiFit
	KERNEL_IN_UBI := 1
...
define DeviceCommon/DniImage
	$(call DeviceCommon/FitzImage)
	NETGEAR_BOARD_ID :=
	NETGEAR_HW_ID :=
	IMAGES += factory.img
...
define Device/8dev_habanero-dvk
	$(call DeviceCommon/FitImageLzma)
...
define DeviceCommon/8dev_jalapeno
	$(call DeviceCommon/FitImage)
	$(call DeviceCommon/UbiFit)
	BLOCKSIZE := 128k
	PAGESIZE := 2048
	SOC := qcom-ipq4018
endef
...
define Device/8dev_jalapeno
	$(call DeviceCommon/8dev_jalapeno)
	DEVICE_VENDOR := 8devices
...
define DeviceCommon/aruba_glenmorangie
	$(call DeviceCommon/FitImageLzma)
	DEVICE_VENDOR := Aruba
	SOC := qcom-ipq4029
endef
...
define Device/aruba_ap-303
	$(call DeviceCommon/aruba_glenmorangie)
	DEVICE_MODEL := AP-303
endef
...
# - change call DeviceCommon/FitImageLzma to DeviceCommon/FitImage
...
define Disabled/avm_fritzrepeater-3000
	$(call DeviceCommon/FitImageLzma)
	DEVICE_VENDOR := AVM
...
define Disabled/buffalo_wtr-m2133hp
	$(call DeviceCommon/FitImage)
	$(call DeviceCommon/UbiFit)
...
define Disabled/cilab_meshpoint-one
	$(call DeviceCommon/8dev_jalapeno)
...
define Disabled/devolo_magic-2-wifi-next
	$(call DeviceCommon/FitImage)
...
define Disabled/edgecore_oap100
	$(call DeviceCommon/FitImage)
	$(call DeviceCommon/UbiFit)
	DEVICE_VENDOR := Edgecore
	DEVICE_MODEL := OAP100
...
define Disabled/engenius_eap1300
	$(call DeviceCommon/FitImage)
...
define Disabled/engenius_eap2200
	$(call DeviceCommon/FitImage)
	$(call DeviceCommon/UbiFit)
	DEVICE_VENDOR := EnGenius
...
define Disabled/engenius_emr3500
	$(call DeviceCommon/FitImage)
	DEVICE_VENDOR := EnGenius
...
define Disabled/engenius_ens620ext
	$(call DeviceCommon/FitImage)
	DEVICE_VENDOR := EnGenius
...
define Disabled/ezviz_cs-w3-wd1200g-eup
	$(call DeviceCommon/FitImage)
	DEVICE_VENDOR := EZVIZ
...
define Disabled/glinet_gl-ap1300
	$(call DeviceCommon/FitImage)
	$(call DeviceCommon/UbiFit)
	DEVICE_VENDOR := GL.iNet
...
define Disabled/glinet_gl-s1300
	$(call DeviceCommon/FitzImage)
	DEVICE_VENDOR := GL.iNet
...
define DeviceCommon/kernel-size-6350-8300
	DEVICE_COMPAT_VERSION := 2.0
...
define Device/linksys_ea6350v3
	...
	$(call DeviceCommon/FitzImage)
	$(call DeviceCommon/kernel-size-6350-8300)
...
define DeviceCommon/netgear_ex61x0v2
	$(call DeviceCommon/DniImage)
...
define Disabled/netgear_ex6100v2
	$(call DeviceCommon/netgear_ex61x0v2)
	DEVICE_MODEL := EX6100
	DEVICE_VARIANT := v2
endef
# Missing DSA Setup

define Disabled/netgear_ex6150v2
	$(call DeviceCommon/netgear_ex61x0v2)
	DEVICE_MODEL := EX6150
	DEVICE_VARIANT := v2
endef
...
define DeviceCommon/netgear_orbi
	$(call DeviceCommon/DniImage)
	SOC := qcom-ipq4019
	DEVICE_VENDOR := NETGEAR
...
define DeviceCommon/netgear_rbx50
	$(call DeviceCommon/netgear_orbi)
...
define Device/netgear_rbr50
	$(call DeviceCommon/netgear_rbx50)
	DEVICE_MODEL := RBR50
	DEVICE_VARIANT := v1
...
define DeviceCommon/netgear_srx60
	$(call DeviceCommon/netgear_orbi)
...
define Device/netgear_srr60
	$(call DeviceCommon/netgear_srx60)
	DEVICE_MODEL := SRR60
...
define DeviceCommon/p2w_r619ac
	$(call DeviceCommon/FitzImage)
	$(call DeviceCommon/UbiFit)
	DEVICE_VENDOR := P&W
	DEVICE_MODEL := R619AC
...
define Disabled/qxwlan_e2600ac-c1
	$(call DeviceCommon/FitImage)
...
define Disabled/qxwlan_e2600ac-c2
	$(call DeviceCommon/FitImage)
	$(call DeviceCommon/UbiFit)
	DEVICE_VENDOR := Qxwlan
	DEVICE_MODEL := E2600AC
...
define Disabled/teltonika_rutx10
	$(call DeviceCommon/FitImage)
	$(call DeviceCommon/UbiFit)
...
define Disabled/unielec_u4019-32m
	$(call DeviceCommon/FitImage)
