...
#define UART_THR			(UART_BASE + 0x0004)
#define UART_LSR			(UART_BASE + 0x001c)
#define UART_LSR_THRE_MASK	(1 << 6)
...
Can be overwritten in board-$(SUBTARGET).c files if needed.
*/
