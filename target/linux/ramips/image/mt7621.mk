...
define DeviceCommon/ampedwireless_ally
  $(DeviceCommon/dsa-migration)
...
define Device/ampedwireless_ally-r1900k
  $(DeviceCommon/ampedwireless_ally)
...
define DeviceCommon/dlink_dir-8xx-a1
  $(DeviceCommon/dsa-migration)
  IMAGE_SIZE := 16000k
  DEVICE_VENDOR := D-Link
  DEVICE_PACKAGES := kmod-mt7615-firmware
...
define DeviceCommon/dlink_dir-8xx-r1
  $(DeviceCommon/dsa-migration)
  IMAGE_SIZE := 16064k
  DEVICE_VENDOR := D-Link
  DEVICE_PACKAGES := kmod-mt7615-firmware
...
define DeviceCommon/dlink_dir-xx60-a1
  $(DeviceCommon/dsa-migration)
  BLOCKSIZE := 128k
  PAGESIZE := 2048
  KERNEL_SIZE := 4096k
...
define Device/dlink_dir-1960-a1
  $(DeviceCommon/dlink_dir-xx60-a1)
...
define Device/dlink_dir-860l-b1
  $(DeviceCommon/dsa-migration)
  $(DeviceCommon/seama-lzma-loader)
...
define DeviceCommon/elecom_wrc-gs
  $(DeviceCommon/dsa-migration)
  $(DeviceCommon/uimage-lzma-loader)
  DEVICE_VENDOR := ELECOM
  IMAGES += factory.bin
...
define DeviceCommon/h3c_tx180x
  $(DeviceCommon/dsa-migration)
  BLOCKSIZE := 128k
  PAGESIZE := 2048
  KERNEL_SIZE := 8192k
...
define DeviceCommon/haier-sim_wr1800k
  $(DeviceCommon/dsa-migration)
  BLOCKSIZE := 128k
  PAGESIZE := 2048
  KERNEL_SIZE := 4096k
...
define Device/haier_har-20s2u1
  $(DeviceCommon/haier-sim_wr1800k)
  DEVICE_VENDOR := Haier
...
define DeviceCommon/iodata_nand
  $(DeviceCommon/dsa-migration)
  DEVICE_VENDOR := I-O DATA
  BLOCKSIZE := 128k
  PAGESIZE := 2048
...
define DeviceCommon/linksys_ea7xxx
  $(DeviceCommon/dsa-migration)
  $(DeviceCommon/uimage-lzma-loader)
  BLOCKSIZE := 128k
  PAGESIZE := 2048
...
define DeviceCommon/netgear_sercomm_nand
  $(DeviceCommon/dsa-migration)
  $(DeviceCommon/uimage-lzma-loader)
  BLOCKSIZE := 128k
  PAGESIZE := 2048
...
define Device/netgear_r6220
  $(DeviceCommon/netgear_sercomm_nand)
  DEVICE_MODEL := R6220
...
define DeviceCommon/ubnt_edgerouter
  $(DeviceCommon/dsa-migration)
  $(DeviceCommon/uimage-lzma-loader)
...
define DeviceCommon/xiaomi_nand_separate
  $(DeviceCommon/dsa-migration)
  $(DeviceCommon/uimage-lzma-loader)
...
define Device/xiaomi_mi-router-3g
  $(DeviceCommon/xiaomi_nand_separate)
...
define DeviceCommon/xiaomi_mi-router-cr660x
  $(DeviceCommon/dsa-migration)
  $(DeviceCommon/uimage-lzma-loader)
  DEVICE_VENDOR := Xiaomi
  BLOCKSIZE := 128k
...
define Device/xiaomi_mi-router-cr6606
  $(DeviceCommon/xiaomi_mi-router-cr660x)
...
define DeviceCommon/zyxel_nwa-ax
  $(DeviceCommon/dsa-migration)
  DEVICE_VENDOR := ZyXEL
  BLOCKSIZE := 128k
  PAGESIZE := 2048
