...
define Device/Common/ampedwireless_ally
  $(Device/Common/dsa-migration)
...
define Device/ampedwireless_ally-r1900k
  $(Device/Common/ampedwireless_ally)
...
define Device/Common/dlink_dir-8xx-a1
  $(Device/Common/dsa-migration)
  IMAGE_SIZE := 16000k
  DEVICE_VENDOR := D-Link
  DEVICE_PACKAGES := kmod-mt7615-firmware
...
define Device/Common/dlink_dir-8xx-r1
  $(Device/Common/dsa-migration)
  IMAGE_SIZE := 16064k
  DEVICE_VENDOR := D-Link
  DEVICE_PACKAGES := kmod-mt7615-firmware
...
define Device/Common/dlink_dir-xx60-a1
  $(Device/Common/dsa-migration)
  BLOCKSIZE := 128k
  PAGESIZE := 2048
  KERNEL_SIZE := 4096k
...
define Device/dlink_dir-1935-a1
  $(Device/Common/dlink_dir-8xx-a1)
...
define Device/dlink_dir-1960-a1
  $(Device/Common/dlink_dir-xx60-a1)
...
define Device/dlink_dir-853-r1
  $(Device/Common/dlink_dir-8xx-r1)
  DEVICE_MODEL := DIR-853
  DEVICE_VARIANT := R1
...
define Device/Common/elecom_wrc-gs
  $(Device/Common/dsa-migration)
  $(Device/Common/uimage-lzma-loader)
  DEVICE_VENDOR := ELECOM
  IMAGES += factory.bin
...
define Device/Common/h3c_tx180x
  $(Device/Common/dsa-migration)
  BLOCKSIZE := 128k
  PAGESIZE := 2048
  KERNEL_SIZE := 8192k
...
define Device/Common/haier-sim_wr1800k
  $(Device/Common/dsa-migration)
  BLOCKSIZE := 128k
  PAGESIZE := 2048
  KERNEL_SIZE := 4096k
...
define Device/haier_har-20s2u1
  $(Device/Common/haier-sim_wr1800k)
  DEVICE_VENDOR := Haier
...
define Device/Common/iodata_nand
  $(Device/Common/dsa-migration)
  DEVICE_VENDOR := I-O DATA
  BLOCKSIZE := 128k
  PAGESIZE := 2048
...
define Device/Common/linksys_ea7xxx
  $(Device/Common/dsa-migration)
  $(Device/Common/uimage-lzma-loader)
  BLOCKSIZE := 128k
  PAGESIZE := 2048
...
define Device/Common/netgear_sercomm_nand
  $(Device/Common/dsa-migration)
  $(Device/Common/uimage-lzma-loader)
  BLOCKSIZE := 128k
  PAGESIZE := 2048
...
define Device/netgear_r6220
  $(Device/Common/netgear_sercomm_nand)
  DEVICE_MODEL := R6220
...
define Device/Common/ubnt_edgerouter
  $(Device/Common/dsa-migration)
  $(Device/Common/uimage-lzma-loader)
...
define Device/Common/xiaomi_nand_separate
  $(Device/Common/dsa-migration)
  $(Device/Common/uimage-lzma-loader)
...
define Device/xiaomi_mi-router-3g
  $(Device/Common/xiaomi_nand_separate)
...
define Device/Common/xiaomi_mi-router-cr660x
  $(Device/Common/dsa-migration)
  $(Device/Common/uimage-lzma-loader)
  DEVICE_VENDOR := Xiaomi
  BLOCKSIZE := 128k
...
define Device/xiaomi_mi-router-cr6606
  $(Device/Common/xiaomi_mi-router-cr660x)
...
define Device/Common/zyxel_nwa-ax
  $(Device/Common/dsa-migration)
  DEVICE_VENDOR := ZyXEL
  BLOCKSIZE := 128k
  PAGESIZE := 2048
