...
define DeviceCommon/kernel-size-migration
...
define DeviceCommon/TpSafeImage
	KERNEL_SUFFIX := -uImage
	KERNEL = kernel-bin | append-dtb | uImage none
	KERNEL_NAME := zImage
	TPLINK_BOARD_ID :=
...
define DeviceCommon/ZyXELImage
	KERNEL_SUFFIX := -uImage
	KERNEL = kernel-bin | append-dtb | uImage none | \
		pad-to $$(KERNEL_SIZE)
	KERNEL_NAME := zImage
...
define Device/linksys_ea7500-v1
	$(call DeviceCommon/LegacyImage)
	$(DeviceCommon/kernel-size-migration)
