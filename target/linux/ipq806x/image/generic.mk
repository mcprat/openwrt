...
define Device/Common/TpSafeImage
	KERNEL_SUFFIX := -uImage
	KERNEL = kernel-bin | append-dtb | uImage none
	KERNEL_NAME := zImage
	TPLINK_BOARD_ID :=
...
define Device/Common/ZyXELImage
	KERNEL_SUFFIX := -uImage
	KERNEL = kernel-bin | append-dtb | uImage none | \
		pad-to $$(KERNEL_SIZE)
	KERNEL_NAME := zImage
...
define Device/arris_tr4400-v2
	$(call Device/Common/LegacyImage)
	DEVICE_VENDOR := Arris
	DEVICE_MODEL := TR4400
	DEVICE_VARIANT := v2
	SOC := qcom-ipq8065
...
define Device/tplink_ad7200
	$(call Device/Common/TpSafeImage)
