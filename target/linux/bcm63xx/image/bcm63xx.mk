...
define Device/Common/bcm63xx-legacy
  $(Device/Common/bcm63xx)
  KERNEL := kernel-bin | append-dtb | relocate-kernel | lzma-cfe
endef

define Device/Common/bcm63xx_netgear
  $(Device/Common/bcm63xx)
...
define Device/Common/bcm63xx_redboot
