...
define Device/tplink_archer-a7-v5
  $(Device/Common/tplink-safeloader-uimage)
  SOC := qca9563
  IMAGE_SIZE := 15104k
...
define Device/tplink_cpe210-v1
  $(Device/Common/tplink-safeloader-okli)
  SOC := ar9344
  IMAGE_SIZE := 7680k
  DEVICE_MODEL := CPE210
  DEVICE_VARIANT := v1
...
define Device/Common/tplink-eap2x5
  $(Device/Common/tplink-safeloader)
  LOADER_TYPE := elf
...
define Device/Common/tplink_rex5x-v1
  $(Device/Common/tplink-safeloader)
  SOC := qca9558
  IMAGE_SIZE := 6016k
