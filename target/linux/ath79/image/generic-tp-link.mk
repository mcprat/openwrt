...
define Device/tplink_archer-a7-v5
  $(DeviceCommon/tplink-safeloader-uimage)
  SOC := qca9563
  IMAGE_SIZE := 15104k
...
define Device/tplink_cpe210-v1
  $(DeviceCommon/tplink-safeloader-okli)
  SOC := ar9344
  IMAGE_SIZE := 7680k
  DEVICE_MODEL := CPE210
  DEVICE_VARIANT := v1
...
define DeviceCommon/tplink-eap2x5
  $(DeviceCommon/tplink-safeloader)
  LOADER_TYPE := elf
...
define DeviceCommon/tplink_rex5x-v1
  $(DeviceCommon/tplink-safeloader)
  SOC := qca9558
  IMAGE_SIZE := 6016k
