...
PKG_MACRO_PATHS?=$(PKG_SOURCE_DIR)/m4
...
HOST_LIBTOOL_PATHS?=$(if $(PKG_LIBTOOL_PATHS),$(PKG_LIBTOOL_PATHS),$(HOST_CONFIGURE_PATH))
HOST_AUTOMAKE_PATHS?=$(if $(PKG_AUTOMAKE_PATHS),$(PKG_AUTOMAKE_PATHS),$(HOST_CONFIGURE_PATH))
HOST_MACRO_PATHS?=$(if $(PKG_MACRO_PATHS),$(PKG_MACRO_PATHS),$(HOST_SOURCE_DIR)/m4)
