...
ifeq ($(CONFIG_EXTERNAL_TOOLCHAIN),)
  ...
  TARGET_TOOL_NAME = $(if $(CONFIG_VERSION_FILENAMES),$(VERSION_NUMBER),$(KERNEL_PATCHVER)$(LINUX_VERSION-$(KERNEL_PATCHVER)))_$(BOARD)$(if $(SUBTARGET),-$(SUBTARGET))_gcc-$(GCCV)$(DIR_SUFFIX).$(HOST_OS)-$(HOST_ARCH)
else
  ...
  TARGET_TOOL_NAME = $(if $(CONFIG_VERSION_FILENAMES),$(VERSION_NUMBER),$(KERNEL_PATCHVER)$(LINUX_VERSION-$(KERNEL_PATCHVER)))_$(BOARD)$(if $(SUBTARGET),-$(SUBTARGET))_$(GNU_TARGET_NAME)_$(LIBC).$(HOST_OS)-$(HOST_ARCH)
endif
